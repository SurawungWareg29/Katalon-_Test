...
// Variabel global
String BillingCode = '119100190026214' // Ganti sesuai kebutuhan
...
try {
    ...
    if (!WebUI.verifyElementPresent(findTestObject('IBB Nasabah/Pembayaran Menu/MPN/p_119100190026214'), 10)) {
        throw new Exception('Objek p_119100190026214 tidak ditemukan!')
    }

    // Ambil teks dari elemen sesudah dan hapus spasi
    String teksSesudah = WebUI.getText(findTestObject('IBB Nasabah/Pembayaran Menu/MPN/p_119100190026214')).replaceAll("\\s", "")
    logger.logInfo("Teks setelah (tanpa spasi): " + teksSesudah)

    // Gunakan verifyMatch untuk memverifikasi teks sebelum dan sesudah
