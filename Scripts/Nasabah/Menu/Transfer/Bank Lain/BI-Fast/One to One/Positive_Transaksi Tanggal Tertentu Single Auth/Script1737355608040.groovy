...
WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/checkbox_Berulang'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/select_tanggalMulai'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/dropdown_tahunTanggalMulai'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/dropdown_tahun2099TanggalMulai'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/datepicker_tanggal15'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/select_tanggalBerakhir'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/dropdown_tahunTanggalBerakhir'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/dropdown_tahun2099TanggalBerakhir'))

WebUI.click(findTestObject('IBB Nasabah/Transfer Menu (Maker)/Halaman Transfer Bank Lain/datepicker_tanggal20'))
